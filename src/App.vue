      ...
      <v-container>
        ...
        >
          <v-flex mb-4>
            ...
            <p class="subheading font-weight-regular">
               DECENTRALIZED SECURE RELIEF FUND USING PEER 2 PEER NETWORK
            </p>
          </v-flex>
        </v-layout>
        ...
        <v-layout row justify-center>
          <v-dialog v-model="startProjectDialog" max-width="600px" persistent>
            ...
            <v-card>
              <v-card-title>
                <span class="headline font-weight-bold mt-2 ml-4">Bring your Life to Normal</span>
              </v-card-title>
...
<script> 
import ReliefFundInstance from '../contracts/ReliefFundInstance';
import ReliefFundProjectInstance from '../contracts/ReliefFundProjectInstance';
...
export default {
  ...
  methods: {
    getProjects() {
      ReliefFundInstance.methods.returnAllProjects().call().then((projects) => {
        projects.forEach((projectAddress) => {
          const projectInst = ReliefFundProjectInstance(projectAddress);
    ...
    startProject() {
      ...
      ReliefFundInstance.methods.startProject(
        ...
        projectInfo.contract = ReliefFundProjectInstance(projectInfo.contractAddress);
